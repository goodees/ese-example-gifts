 ...
 */
@Value.Immutable
public interface WishContentChangedEvent extends GiftEvent {
    String id();
    String newContent();
    ...
    class Builder extends ImmutableWishContentChangedEvent.Builder implements FromEntity<Builder> {
